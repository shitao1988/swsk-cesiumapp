...
import circlegraypng from './images/circle_gray.png';
...
GlobePolygonMeasure.prototype = {
    ...
    modifyHandler: null,
    callback: null,
    dragIcon: circlegraypng,
    dragIconLight: circleredpng,
    material: null,
    ...
    _computeArea: function (positions) {
        ...
        var polygon = turfPolygon([arr]);
        var area = turfArea(polygon) / 1000 / 1000;
        return area;
    },
