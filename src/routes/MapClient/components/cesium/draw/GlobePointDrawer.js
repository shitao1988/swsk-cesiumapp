...
import circleredpng from './images/circle_red.png'
...
GlobePointDrawer.prototype = {
    ...
    _showToolBar: function () {
        ...
        _this.toolBarIndex = layer.open({
            ...
            resize: false,
            shade: 0,
            content: document.getElementById("shapeEditContainer"),
    ...
    _createToolBar: function () {
        var _this = this;
        var objs = document.getElementById("shapeEditContainer");
        objs&&objs.parentNode.removeChild(objs);
        var html = '<div id="shapeEditContainer" style="padding: 10px 10px;">'
                 + '    <button id="btnOK" class="layui-btn layui-btn-xs layui-btn-normal"> <i class="layui-icon"></i> 确定 </button>'
                 + '    <button id="btnCancel" class="layui-btn layui-btn-xs layui-btn-danger"> <i class="layui-icon">ဆ</i> 取消 </button>'
