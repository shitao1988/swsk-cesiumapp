  ...
  render() {
    ...
    return (
      <div className="copyline_bottom">
        <div id="scalebar"><a onClick={this.showContactModal}>联系我们</a>&nbsp;&nbsp;<a onClick={this.showReliefModal}>免责说明</a></div>
        ...
        >
          <div className="infoText">
            <div className="infoText-item">
            	<span className="iconfont icon-mingcheng"></span>
              名称：<font>无锡市自然资源和规划局</font>
            </div>
            <div className="infoText-item">
        ...
        >
          <Alert style={{ marginBottom: 10 }}
            description="感谢使用本应用，您在使用过程中遇到的各种问题，或者对我们产品有任何建议，都欢迎您通过意见反馈向我们提出。我们会认真研究您所提供的反馈，来不断完善我们的产品和服务。"
            type="info"
          />
